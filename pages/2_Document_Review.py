...
from utils import extract_text_from_upload, initialize_state, inject_custom_css, render_top_nav, review_paper, summarize_text
...
if uploaded:
    try:
        st.session_state.paper_text = extract_text_from_upload(uploaded)
        st.session_state.paper_summary = summarize_text(st.session_state.paper_text)
